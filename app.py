        ...
        if selected_stocks:
            ...
            if annual_pretax_income > 20000000:
                 st.error(f"""
                    ...
                    예상 연 배당금(세전)이 **{annual_pretax_income/10000:,.0f}만원**으로, 기준인 **2,000만원을 초과**했습니다.
                    이 경우 2천만원을 초과하는 소득은 다른 소득(근로, 사업 등)과 합산되어 누진세율이 적용될 수 있습니다.
                    *(일반 계좌 기준이며, ISA/연금 계좌는 과세 방식이 다릅니다.)*
                """)
            # ----------------------------------------
